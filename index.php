...
<?php
    ...
    $conn = @mysql_connect ( "mysql.hostinger.co.uk", "u877267001_wstat", "wstats") or die (mysql_error());
    $rs = @mysql_select_db ( "u877267001_wstat", $conn ) or die (mysql_error());
		...
		<div id="page-wrapper">
			...
			<!-- Header -->
				<header id="header" class="alt">
					<h1><a href="index.php">Web Server Scripting</a> by Jordan Roden</h1>
					<nav id="nav">
						<ul>
					...
					<section class="box special features">
						<div class="features-row">
							<section>
								...
								<h3>File Uploader</h3>
								<p>Please use the button below to upload a File.</p>
							...
							<section>
								...
								<h3>Guestbook</h3>
								<p>Enter things here...</p>
                                <form action="display_messages.php" method="post">
                                    <table>
                                        <tr>
